...
namespace Client
{
    public partial class mClient : Form
    {
        string last_let = "";
       ...
       //start of network codes
        ...
        private void mClient_Load(object sender, EventArgs e)
        {
            p1 = true;
        ...
        private void mClient_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (File.Exists(dictionary))
            {
